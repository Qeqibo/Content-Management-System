<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/TemplateAdmin/AnaTema/master.Master"  AutoEventWireup="true" CodeBehind="haberler.aspx.cs" Inherits="Gazi.KazanMYO.SubeProje.AnaTema.haberler" %>
		         			...
		         			<div class="image group marketing">
									<div class="grid images_3_of_1">
										...
										<div class="grid blog-desc">
											<h4><a href="#"><%#Eval("HaberBaslik")%></a></h4>
											<p><%#Eval("Icerik")%></p>
											<div class="view-all"><a href="<%# String.Format("{0}/{1}",Eval("HaberID").ToString(),KodOlustur(Eval("HaberBaslik").ToString())) %>">Devamını Gör</a></div>
									 </div>
